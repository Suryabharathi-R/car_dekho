...
model = joblib.load('C:/Users/surya/Downloads/car_price_prediction_model.pkl')
label_encoders = joblib.load('C:/Users/surya/Downloads/label_encoders.pkl')
scalers = joblib.load('C:/Users/surya/Downloads/scalers.pkl')

# Load dataset for filtering and identifying similar data
data = pd.read_csv('C:/Users/surya/Downloads/car_dekho_cleaned_dataset_Raw.csv')
